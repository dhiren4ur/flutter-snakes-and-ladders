            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  // FIXED: Reduced height and optimized spacing
                  SizedBox(
                    height: 300, // REDUCED: from 320 to 300 pixels
                    child: Column(
                      children: [
                        // Play with Friends
                        Expanded(
                        ...
                        children: [
                          ...
                          if (_selectedMode == 1)
                            _buildPlayerCountSelector(
                              ...
                              options: const [1, 2, 3],
                              onChanged: (count) => setState(() => _aiCount = count),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  maxLines: 1, // ADDED: Prevent text overflow
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  int _getTotalPlayers() {
    // For AI mode: always 1 human + num of AI
    // For Friends mode: number of humans
    return widget.gameMode == 0 ? widget.playerCount : (1 + widget.aiCount);
  }

  bool _isAIPlayer(int index) {
    // For AI mode: player 0 = human, others = AI
    return widget.gameMode == 1 && index > 0;
  }

  void _startGame() async {
    List<String> names = controllers.map((controller) => controller.text.trim()).toList();
    ...
    // Defensive: Ensure all fields filled (just for polish)  
                          ...
                          return Container(
                            ...
                            child: Padding(
                              ...
                              child: TextField(
                                ...
                                style: GoogleFonts.nunito(
                                  color: _isAIPlayer(index) ? Colors.grey : Colors.white,
                                  fontSize: 16,
                                ),
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: Icon(
                                    _isAIPlayer(index) ? Icons.smart_toy : Icons.person,
                                    color: Colors.blueAccent,
                                  ),
                                ),
                                maxLength: 15,
